...
training_queries = Queries.load_from_text('50k_train_50000.txt')
validation_queries = Queries.load_from_text('50k_validation_10000.txt')
test_queries = Queries.load_from_text('50k_test_50000.txt')
